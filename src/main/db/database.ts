...
import { CREATE_TABLES_SQL, SEED_SCHEMA_VERSION, MIGRATE_V1_TO_V2, MIGRATE_V2_TO_V3, MIGRATE_V3_TO_V4, MIGRATE_V4_TO_V5, MIGRATE_V5_TO_V6, MIGRATE_V6_TO_V7, MIGRATE_V7_TO_V8, MIGRATE_V8_TO_V9, MIGRATE_V9_TO_V10, MIGRATE_V10_TO_V11, MIGRATE_V11_TO_V12, MIGRATE_V12_TO_V13, MIGRATE_V13_TO_V14, MIGRATE_V14_TO_V15, MIGRATE_V15_TO_V16, MIGRATE_V16_TO_V17, MIGRATE_V17_TO_V18, MIGRATE_V18_TO_V19, MIGRATE_V19_TO_V20, MIGRATE_V20_TO_V21, MIGRATE_V21_TO_V22, MIGRATE_V22_TO_V23 } from './schema'
...
export function initDatabase(): Database.Database {
  ...
  try {
    ...
    if (version < 21) migrate(MIGRATE_V20_TO_V21)
    if (version < 22) migrate(MIGRATE_V21_TO_V22)
    if (version < 23) migrate(MIGRATE_V22_TO_V23)
  } catch (err) {
    db.close()
    db = null
    throw err
