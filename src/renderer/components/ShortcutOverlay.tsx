...
export function ShortcutOverlay({ onClose }: ShortcutOverlayProps) {
  ...
  const SHORTCUTS: ShortcutEntry[] = [
    ...
    { keyKey: 'shortcuts.tk.leftDragEmpty',    labelKey: 'shortcuts.keyLeftDragPan' },
    { keyKey: 'shortcuts.tk.rightClickDrag',   labelKey: 'shortcuts.keyRightDragPan' },
    ...
    { keyKey: 'shortcuts.tk.spaceDrag',        labelKey: 'shortcuts.keySpaceDragPan' },
    { keyKey: 'shortcuts.tk.shiftDrag',        labelKey: 'shortcuts.keyShiftDragRubber' },
    ...
    { key: 'Ctrl + B',         labelKey: 'shortcuts.keyLeftSidebar' },
    ...
    { key: 'Ctrl + Shift + B', labelKey: 'shortcuts.keyBlackout' },
